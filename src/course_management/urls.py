...
urlpatterns = [
    ...
    url(r'^course/(?P<course_id>[0-9]+)/activate$', course.activate, name='activate-course'),
    url(r'^course/(?P<course_id>[0-9]+)/deactivate$', course.deactivate, name='deactivate-course'),
